    ...
    <>
      <section>
        <p className="mb-4 md:mx-24">
          ...
          capabilities and also to make a productivity tool that combined
          different tools I already use.
        </p>
        <p className="mb-4 md:mx-24">
          In the app, there is a pomodoro timer that can use custom intervals,
          as well as a todo list that has countdown timers for each task.
        </p>
        ...
        <p className="mb-4 md:mx-24">
          I have found that countdowns help me get tasks done sooner, so I made
          sure to incorporate that into the app.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="grid lg:grid-cols-2 lg:mx-24 gap-12 items-center justify-center">
          <div className="md:text-lg">
            <p className="mb-4 lg:mb-8">
              The standard pomodoro technique calls for 25 minute work intervals
              and 5 minute break intervals.
            </p>
            <p className="mb-4 lg:mb-8">
              I have found that as you use the technique more, you may want
              longer work intervals.
            </p>
            <p className="mb-4 lg:mb-8">
              To address this, I have included the option to fully customize the
              intervals.
            </p>
            <p className="mb-4 lg:mb-8">
              It will also calculate the total time the full set will take.
            </p>
          </div>
          <img
        ...
        <div className="grid lg:mx-24 items-center justify-center">
          <div className="md:text-lg">
            <p className="mb-4 lg:mb-8">
              When the work interval beings and as a rest interval is ending,
              associated sounds will play.
            </p>
        ...
        <div className="grid lg:grid-cols-2 lg:mx-24 gap-12 items-center justify-center">
          <div className="md:text-lg">
            <p className="mb-4 lg:mb-8">
              The user can add todo items, each having their own finish
              date/time. The remaining time for each task is displayed as a
              countdown and can be disabled.
            </p>
          </div>
          <video
        ...
        <h4 className="text-center mb-4 mt-12">Editing/Deleting Todos</h4>
        ...
        <div className="grid lg:mx-24 items-center justify-center">
          <div className="md:text-lg">
            <p className="mb-4 lg:mb-8 lg:mx-24">
              All todo items are stored in the browser's local storage. This
              keeps the users data inaccessible to other users and ensures data
        ...
        <div className="grid lg:grid-cols-2 lg:mx-24 gap-12 items-center justify-center">
          <div className="md:text-lg">
            <p className="mb-4 lg:mb-8">
              In the settings menu, there are options to hide elements on the
              page.
            </p>
            <p className="mb-4 lg:mb-8">
              Todo coundowns can be overwhelming for some, so the option to
