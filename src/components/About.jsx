      ...
      <div className="lg:col-span-1 xl:col-span-3 flex flex-col md:items-left">
        ...
        <div className="mx-auto lg:mx-0">
          ...
          <a href="mailto:connor.ragland@hotmail.com">
            <button className="bg-zinc-600 bg-opacity-30 py-2 px-4 mt-4 rounded-md hover:scale-[1.02]">
              Contact
            </button>
          </a>
          ...
          <a
            href="/resume/raglandconnor_resume.pdf"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className="bg-zinc-600 bg-opacity-30 ml-2 py-2 px-4 mt-4 rounded-md hover:scale-[1.02]">
              Resume
            </button>
          </a>
        </div>
